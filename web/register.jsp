<%-- 
    Document   : register
    Created on : 29 Jan, 2023, 2:58:00 PM
    Author     : Seeta Ram
--%>
    ...
    <head>
        ...
        <script>
            ...
            function validation()
            {
                ...
                {
                    document.getElementById('dob_e').innerHTML = "Required dd/mm/yyyy Dormate";
                    return false;
                }
        ...
        <div class="container-fluid">
            ...
            <jsp:include page="menubar.jsp"></jsp:include>
                <div class="row form_bg">
                    ...
                    <div class="col-md-8">
                        <form method="Post"  class="form_register profile_border" name="regform" onsubmit="return validation()" action="reg"> 
                            ...
                            <span id="dob_e" style="color: red; font-size : 12px; margin-right: 310px;"></span><br>
