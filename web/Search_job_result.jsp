<%-- 
    Document   : Search_job_result
    Created on : 24 Jun, 2023, 2:23:05 PM
    Author     : Seeta Ram
--%>
...
//                String sql = "select*from jobs where job_profile LIKE ='%"+technology+"%' and job_location LIKE ='%"+location+"%';
                PreparedStatement ps = con.prepareStatement("select * from jobs where job_profile LIKE '%"+technology+"%' AND job_location LIKE '%"+location+"%'");
                ...
                <div class="row job_edit" >
                    ...
                    <div class="col-md-8">
                        ...
                        <span> <span class="glyphicon glyphicon-file"></span>  <span class="job_c job_font"> Job Discription : </span> <jsp:expression>discription</jsp:expression> </span> <br>
